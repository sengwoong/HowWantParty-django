"""
Django settings for HowWantParty project.
...
SECRET_KEY = 'django-insecure-1hq$8)w*oiv4r-)htpie0^bbk_x1gl&^v3)q%n&ua(@ls+b)@k'
...
ROOT_URLCONF = 'HowWantParty.urls'
...
WSGI_APPLICATION = 'HowWantParty.wsgi.application'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://localhost:6379/HowWentParty',  
        'OPTIONS': {
